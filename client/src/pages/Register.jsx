    ...
    <div className="max-w-md mx-auto mt-12">
      <div className="bg-white p-8 rounded-[var(--radius-lg)] shadow-[var(--shadow-level-2)] border border-[var(--color-surface-dim)]">
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-[#1a1b1e]">Create an Account</h2>
          <p className="text-[var(--color-secondary)] mt-2">Join CampusRetriever today</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label className="block text-sm font-semibold text-[#1a1b1e] mb-1">Username</label>
            <input
              type="text"
              required
              value={username}
          ...
          <div>
            ...
            <input
              ...
              placeholder="••••••••"
            />
            <p className="text-xs text-[var(--color-secondary)] mt-1">Must be at least 6 characters long.</p>
          </div>
